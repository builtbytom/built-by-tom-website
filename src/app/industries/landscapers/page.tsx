        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="text-3xl font-bold text-primary mb-2">$2,997 - $4,500</div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="text-5xl mb-4">⚡</div>
              <h3 className="font-bold text-2xl text-foreground mb-4">
                <span className="text-5xl mr-2">⚡</span> Full Automation Setup
              </h3>
              <div className="text-3xl font-bold text-primary mb-2">$1,297</div>
              <p className="text-text-light">
